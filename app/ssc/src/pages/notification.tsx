                        ...
                        {notification.dismissible && (
                            <Button
                                ...
                                className={cn(
                                    ...
                                    notification.type === "warning" && "text-red-900 hover:text-red-800",
                                    notification.type === "info" && "text-gray-900 hover:text-gray-800",
                                    notification.type === "success" && "text-green-900 hover:text-green-800"
                                )}
